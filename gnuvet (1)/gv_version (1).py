...
help = dict(
    ...
    Without options, GnuVet is launched.
""",
    de = """Anwendung: gnuvet [Optionen]
       -h, --help        Diese Meldung anzeigen
       -V, --version     Versions-Information anzeigen
    Ohne Optionen wird GnuVet gestartet.
""",
    )
copyleft = dict(
    en = """GnuVet is Free and Open Source Software, published under the GNU Public License (GPL), and comes without any warranty of any kind, not even the warranty to be USEABLE for ANYTHING in particular.
